...
public class ResultRepositoryBuilder {
	...
	public static Component build(PAGCMTypeFactory patf, PAGenericFactory pagf, Node node, boolean managed) throws InstantiationException {
		...
		ControllerDescription controllerDesc = new ControllerDescription(MMConstants.RESULT_REPOSITORY_COMP, Constants.PRIMITIVE);
		ContentDescription contentDesc = new ContentDescription(ResultRepositoryImpl.class.getName());
