...
public class TesterBuilder {
	...
	public static Component build(PAGCMTypeFactory patf, PAGenericFactory pagf, Node node, boolean managed) throws InstantiationException {
		...
		ControllerDescription controllerDesc = new ControllerDescription(MMConstants.TESTER_COMP, Constants.PRIMITIVE);
		ContentDescription contentDesc = new ContentDescription(TesterImpl.class.getName());
